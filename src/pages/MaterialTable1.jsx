...
const MaterialTable = () => {
  ...
  // const generateData = (startNumber, count) => {
  //   const data = [];
  //   for (let i = 0; i < count; i++) {
  //     const sr = startNumber + i;
  //     data.push({
  //       sr: sr.toString(),
  //       ordDate: `Fri, 12th Jan, 2024 10:41 AM ${sr}`,
  //       DeliveryDate: `${sr}`,
  //       OrderId: `OR_1418${sr}`,
  //       OrderStatus: `Order Received${sr}`,
  //       CustomerName: `HARSHAL MHATRE${sr}`,
  //       CustomerMobile: `9879816216${sr}`,
  //       CustEmail: `harshal.mhatre@anmsoft.com ${sr}`,
  //       SKU: `DYOJ_0000000091${sr}`,
  //       ProdName: `Classic Traditional Bangle Pair Design Set with Precious Coloured Gemstones${sr}`,
  //       OrderVal: `12850.00${sr}`,
  //       PayMode: `Cash On Delivery${sr}`,
  //       RazorPayID: `-${sr}`,
  //     });
  //   }
  //   return data;
  ...
  // const newData = generateData(1, 100);
  // console.log(newData);
